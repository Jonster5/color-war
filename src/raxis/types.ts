...
export type Component<T extends GenericConstructor = CompType> = (T extends GenericConstructor<
    infer R
>
...
export type EventData<T extends EventType> = T extends string
    ? T
    : T extends GenericConstructor<infer I>
    ? I
    : never;
